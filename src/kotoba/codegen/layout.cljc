(ns kotoba.codegen.layout
  ...
  This is the shared MC/layout boundary. It deliberately owns neither KIR
  lowering, register allocation, nor target instruction encoders.")
